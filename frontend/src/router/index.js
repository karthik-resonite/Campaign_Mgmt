...
const publicPages = [
  '/finearc/login',
  '/finearc/register',
  '/finearc/forgot-password',
  '/finearc/verification',
  '/finearc/new-password'
];
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import('@/views/campaign/customer_list.vue')
            },
            {
                path: 'customer_data',
                name: 'customer_data',
                meta: {
                    breadcrumb: ['Add Customer Data']
                },
                component: () => import('@/views/campaign/customer_data.vue')
            },
	    {
                path: 'user',
                name: 'user',
                ...
                component: () => import('@/views/campaign/user.vue')
            },
            {
                path: 'company_list',
                name: 'company_list',
            ...
            },
            {
                ...
                component: () => import('@/views/campaign/analysis.vue')
            },
            {
                path: 'campaign_list',
                name: 'campaign_list',
...
router.beforeEach((to, from, next) => {
  ...
  if (isAuth && publicPages.includes(to.path)) {
    // Logged in user trying to access public page
    next('/finearc/dashboard');
  } else if (!isAuth && !publicPages.includes(to.path)) {
