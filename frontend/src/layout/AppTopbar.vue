...
const router = useRouter(); // ✅ instance of router
...
const resetInactivityTimer = () => {
  ...
  inactivityTimer = setTimeout(() => {
    autologout (); // auto-logout after 30 mins
  }, INACTIVITY_LIMIT);
};
...
const logout = () => {
  if (window.confirm("Are you sure you want to logout?")) {
    ...
    router.replace("/finearc/login"); // redirect to login page
  }
};
                ...
                <li class="profile-item static sm:relative">
                    ...
                    >
                        <ul class="flex flex-col gap-1">
                            ...
                            <li>
                                <router-link
    to="/finearc/change_password"
    class="label-small dark:text-surface-400 flex gap-2 py-2 px-2.5 rounded-lg items-center hover:bg-emphasis transition-colors duration-150"
  >
    <i class="pi pi-key" />
